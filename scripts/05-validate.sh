...
require_file "ami-files/etc-systemd-system/npm-restore-verify.service"
require_file "ami-files/etc-systemd-system/npm-restore-verify.timer"
...
require_file "ami-files/etc-systemd-system/npm-health-endpoint.service"
...
require_file "ami-files/usr-local-bin/npm-backup-s3-check"
require_file "ami-files/usr-local-bin/npm-health-endpoint"
require_file "ami-files/usr-local-bin/npm-cert-check"
require_file "ami-files/usr-local-bin/npm-restore"
require_file "ami-files/usr-local-bin/npm-restore-verify"
...
require_file "ami-files/etc/northstar/npm-image.conf"
...
PY_CANDIDATES=(
  ...
  "$AMI_FILES/usr-local-bin/npm-health-endpoint"
)
...
require_grep "$AMI_FILES/usr-local-bin/npm-helper" "subparsers\.add_parser\\([[:space:]]*\"set-channel\""
...
require_grep "$AMI_FILES/usr-local-bin/npm-helper" "--alarm-action-arn"
require_grep "$AMI_FILES/usr-local-bin/npm-helper" "--ok-action-arn"
...
require_grep "$REPO_ROOT/docs/operations.md" "npm-restore-verify"
require_grep "$REPO_ROOT/docs/operations.md" "--alarm-action-arn"
...
require_grep "$REPO_ROOT/docs/reliability-scorecard.md" "restore-verify-latest.json"
require_grep "$REPO_ROOT/docs/backup-restore.md" "npm-restore-verify.timer"
require_grep "$REPO_ROOT/docs/monitoring-and-metrics.md" "sns:Publish"
