...
CREDENTIALS_PATH = "/root/.northstar/npm-admin-credentials"
LEGACY_CREDENTIALS_PATH = "/root/npm-admin-credentials.txt"
...
def migrate_legacy_credentials(
    ...
    new_path: str = CREDENTIALS_PATH
) -> Path:
    """
    Ensure credentials live at the new path, migrating from legacy if needed.

    Returns:
        Path to the preferred credentials file (new if available, else legacy).
    """
    ...
    if legacy.exists() and legacy.is_file() and not legacy.is_symlink() and new.exists():
        try:
            legacy.unlink()
...
def build_motd_script(ip: str, username: str, creds_path: str = CREDENTIALS_PATH) -> str:
    """
...
# Nginx Proxy Manager (NPM) for AWS - Login Information
# This file is auto-generated by npm-init.py

if [ -f /var/lib/npm-init-complete ]; then
    echo ""
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo "  Nginx Proxy Manager (NPM) for AWS — by Northstar Cloud Solutions"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
    ...
    echo "            Run 'npm-helper show-creds' to view stored credentials"
    echo ""
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
fi
